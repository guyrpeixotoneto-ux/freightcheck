-- Reconciliar o que a 0033 cria e o bridge remove.
--
...
--
-- A `0033` acrescentou três colunas a `change_set`, e as três saem no `down`
...
-- comparação as reescreve, e a `0033` já marca como `STALE` o que precisa disso.
