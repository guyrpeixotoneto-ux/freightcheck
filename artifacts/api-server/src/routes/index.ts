...
import finameRouter from "./finame";
import financiamentoRealRouter from "./financiamento-real";
import ipvaRouter from "./ipva";
import aquisicaoRouter from "./aquisicao";
import aluguelRouter from "./aluguel";
import impostosRouter from "./impostos";
import seguroRouter from "./seguro";
import manutencaoRouter from "./manutencao";
import kmRodadoRouter from "./km-rodado";
import pneuRouter from "./pneu";
import consumoRouter from "./consumo";
import velocidadeMediaRouter from "./velocidade-media";
import tmaRouter from "./tma";
import lucroFixoRouter from "./lucro-fixo";
import alteracoesPorModuloRouter from "./alteracoes-por-modulo";
import ultimasAlteracoesRouter from "./ultimas-alteracoes";
import calcularParRouter from "./calcular-par";
import monitorCustoFixoRouter from "./monitor-custo-fixo";
import monitorEquipeRouter from "./monitor-equipe";
...
router.use(finameRouter);
router.use(financiamentoRealRouter);
router.use(ipvaRouter);
router.use(aquisicaoRouter);
router.use(aluguelRouter);
router.use(impostosRouter);
router.use(seguroRouter);
router.use(manutencaoRouter);
router.use(kmRodadoRouter);
router.use(pneuRouter);
router.use(consumoRouter);
router.use(velocidadeMediaRouter);
router.use(tmaRouter);
router.use(lucroFixoRouter);
router.use(monitorCustoFixoRouter);
router.use(alteracoesPorModuloRouter);
router.use(ultimasAlteracoesRouter);
router.use(calcularParRouter);
router.use(monitorEquipeRouter);
...
/*
  ...
  uma vigência para a outra. Não tem leitura própria de "o que mudou" — usa
  `/changes/latest`, de `changesRouter` — só guarda o texto que o gestor
  escreveu.
