 ...
 *
 * O catálogo é função da base pelo mesmo motivo que o menu é
 * (`navGroupsFechamento`): as etapas são as mesmas nos dois fechamentos — Rota
 * e Empurrada correm o mesmo processo —, e o que muda entre eles é só o
 * endereço em que cada uma atende. Os atalhos de "onde olhar hoje" não entram
 * nessa conta: eles apontam para a Auditoria, que é uma só.
 */
...
export function etapasDoFechamento(base: string): EtapaFechamento[] {
  return [
    // -------------------------------------------------------------------------
    // Apuração
    // -------------------------------------------------------------------------
