...
export interface FiltrosDeAquisicao {
  busca: string;
  tipo: string;
   ...
   *
   * Existe porque as outras quatro são cadastro e alíquota: uma lista que mistura
   * `20%`, `agosto` e `R$ 665.929,99` na mesma coluna de valores só é comparável
   * linha a linha quando se lê uma grandeza de cada vez.
   */
  soNota: boolean;
}

export const FILTROS_VAZIOS: FiltrosDeAquisicao = {
  busca: "",
  tipo: "TODOS",
  papel: "TODOS",
  variavel: "TODAS",
