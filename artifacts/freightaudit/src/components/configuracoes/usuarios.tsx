...
/**
 * Usuários — quem entra, com que papel e o que cada pessoa alcança.
 *
 ...
 * contas; OPERADOR usa o produto. Quem decide é o servidor — aqui a gestão fica
 * escondida de quem não pode usá-la, em vez de renderizada para falhar — sem
