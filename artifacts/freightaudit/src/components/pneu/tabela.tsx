 ...
 *
 * **A coluna "Unidade" é indispensável nesta tabela.** Três linhas seguidas do
 * mesmo trecho podem ser `0,0312 R$/km`, `R$ 2.000,00` (por pneu) e `480.000 km`
 * (de vida útil). Sem a unidade ao lado do nome, a coluna de valores parece uma
 * grandeza só — e soma como se fosse.
 *
 * **O selo de estado tem texto, e não só cor.** Quem não distingue o verde do
 * vermelho continua lendo "Alterado" e "Conflito".
 */
export function TabelaDePneu({
  linhas,
  justificadaPor,
  onAbrir,
  onJustificar,
  ...
  onAbrir: (linha: LinhaDePneu) => void;
    ...
    <div className="superficie overflow-x-auto">
      <table className="w-full min-w-[58rem] border-collapse text-sm">
        <caption className="sr-only">
          Comparação do pneu entre a vigência base e a comparada, por trecho e variável.
        </caption>
        <thead>
